  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white">
      ...
      {isAddPatientModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-lg w-[90%] max-w-6xl h-[85vh] flex overflow-hidden">
            {/* Left panel - Navigation */}
            <div className="w-72 bg-gray-50 border-r border-gray-200 p-6 flex flex-col h-full">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">New Patient</h2>
            ...
            <div className="flex-1 p-6 overflow-y-auto">
              ...
              <div className="max-w-3xl mx-auto">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-6">
                      ...
                      <InputField
                        ...
                        value={newPatient.preferredPharmacy}
                        onChange={handleNewPatientChange}
                      />
                    </div>
                  </div>
                ...
                {activeSection === "insurance" && (
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-6">Insurance</h3>
                    <div className="grid grid-cols-2 gap-6">
                      <InputField
